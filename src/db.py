...
def validate_form_data(data):
    required_fields = ['fullName', 'loanAmount', 'medicalEmergencyDetails', 'estimatedMedicalExpenses']
...
def create_loan_application():
    ...
    if is_valid:
        try:
            ...
            return jsonify({"message": "Your loan has been predicted successfully."}), 201
